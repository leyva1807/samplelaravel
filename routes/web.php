...
Auth::routes();
Route::resource('titular-tarjetas', TitularTarjetaController::class);
...
Route::group(['namespace' => 'App\Http\Controllers'], function () {
    ...
    Route::controller(FacturaCompraController::class)->group(function () {
        Route::get('FacturaCompra/create', 'Create')->middleware('auth')->name('FacturaCompra/create');
        Route::get('FacturaCompra/index', 'index')->middleware('auth')->name('FacturaCompra/index');
    });
